...
// GPIO 4
#define M1_DIRECTION_DDR DDRD
#define M1_DIRECTION_PORT PORTD
#define M1_DIRECTION_PIN PIND4
// GPIO 7
#define M2_DIRECTION_DDR DDRE
#define M2_DIRECTION_PORT PORTE
#define M2_DIRECTION_PIN PINE6
// GPIO 5
#define M1_SPEED_DDR DDRC
#define M1_SPEED_PORT PORTC
#define M1_SPEED_PIN PINC6
// GPIO 6
#define M2_SPEED_DDR DDRD
#define M2_SPEED_PORT PORTD
#define M2_SPEED_PIN PIND7
// -------
#define M1_SPEED_VALUE OCR3A
#define M2_SPEED_VALUE OCR4D
